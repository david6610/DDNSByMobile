...
/* Variables' number */
//#define NumbOfVar               ((u8)220)
#define NumbOfVar               ((u8)((PARA_L_IP	* PARA_ACCOUNT_IP       + \
									   PARA_L_PHONE	* PARA_ACCOUNT_PHONE 	+ \
									   PARA_L_WEB	* PARA_ACCOUNT_WEB      + \
									   PARA_L_WEB	* PARA_ACCOUNT_EMAIL)/2))
